...
void D3DApp::OnResize()
{
    ...
    const CD3DX12_RESOURCE_BARRIER resourceBarrier{ CD3DX12_RESOURCE_BARRIER::Transition(mDepthStencilBuffer.Get(),
        D3D12_RESOURCE_STATE_COMMON,
...
{
    return mSwapChainBuffer[mSwapChain->GetCurrentBackBufferIndex()].Get();
}
...
D3D12_CPU_DESCRIPTOR_HANDLE D3DApp::CurrentBackBufferView() const
{
    return CD3DX12_CPU_DESCRIPTOR_HANDLE(
        ...
        (INT)mSwapChain->GetCurrentBackBufferIndex(),
        mRtvDescriptorSize);
}
