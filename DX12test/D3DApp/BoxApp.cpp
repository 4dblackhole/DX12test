...
void BoxApp::Draw(const GameTimer& gt)
{
	...
	mCommandList->ClearRenderTargetView(rtv, Colors::AliceBlue, 0, nullptr);
	...
	const auto vbView = mBoxGeo->VertexBufferView();
	const auto ibView = mBoxGeo->IndexBufferView();
	...
	const auto transition2 = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(),
...
void BoxApp::BuildRootSignature()
{
	...
	if (errorBlob != nullptr) OutputDebugStringA((const char*)errorBlob->GetBufferPointer());
...
void BoxApp::BuildBoxGeometry()
{
	array<Vertex, 8> vertices =
	{
		...
		Vertex({XMFLOAT3(-1.0f,-1.0f, 1.0f), XMFLOAT4(Colors::AliceBlue)}),
		Vertex({XMFLOAT3(-1.0f, 1.0f,-1.0f), XMFLOAT4(Colors::BlueViolet)}),
		Vertex({XMFLOAT3(-1.0f, 1.0f, 1.0f), XMFLOAT4(Colors::SkyBlue)}),
		Vertex({XMFLOAT3(1.0f,-1.0f,-1.0f), XMFLOAT4(Colors::DeepSkyBlue)}),
		Vertex({XMFLOAT3(1.0f,-1.0f, 1.0f), XMFLOAT4(Colors::LightBlue)}),
		Vertex({XMFLOAT3(1.0f, 1.0f,-1.0f), XMFLOAT4(Colors::LightSteelBlue)}),
		Vertex({XMFLOAT3(1.0f, 1.0f, 1.0f), XMFLOAT4(Colors::SteelBlue)})
	};
